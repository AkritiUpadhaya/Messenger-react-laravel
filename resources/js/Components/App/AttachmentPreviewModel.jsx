...
import { ChevronLeftIcon, ChevronRightIcon, PaperClipIcon, XMarkIcon } from '@heroicons/react/16/solid'
import React, { Fragment, useEffect, useMemo, useState } from 'react'

const AttachmentPreviewModel = (attachments,index, show=false, onClose=()=>{}) => {
                    ...
                    <TransitionChild
                      ...
                      leaveTo='opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95'>
                        ...
                        >
                            <button 
                            onClick={close}
                            className='absolute right-top top-3 w-10 rounded-full hover:bg-black/10 transition flex items-center justify-center text-gray-100 z-40'>
